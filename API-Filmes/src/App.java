...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        for (Map<String,String> filme : ListaDeFilmes) {
            ...
            System.out.println("\u001b[1m\u001b[97m\u001b[104;1mTitulo:\u001b[m\u001b[3m " + filme.get("title") + "\u001b[m");//Pega o titulo
            System.out.println("\u001b[1m\u001b[97m\u001b[104;1mPoster:\u001b[m\u001b[3m " + filme.get("image") + "\u001b[m");//Pega o poster
            Float imDbRatingToFloat = Float.parseFloat(filme.get("imDbRating"));//Trata a variavel de classificação
            System.out.println("\u001b[90m\u001b[103;1mClassificação: \u001b[3m" + imDbRatingToFloat + "\u001b[m");//Devolve a classificação
            while (contador <= imDbRatingToFloat-1) {//Desenha o emoji = classificação
                contador ++;
                System.out.print("💙️");
